...
void* MemoryManager::allocate(size_t sizeInBytes) {
    ...
    return static_cast<void*>(memoryStart + offsetWords * wordSize);
}
...
void MemoryManager::free(void* address) {
    ...
    size_t offsetBytes = static_cast<uint8_t*>(address) - memoryStart;
...
void MemoryManager::initialize(size_t sizeInWords) {
    // return error if greater than 65536 (specificed in presentation / discussion)
...
// shutdown memory manager and deallocate memory
...
void* MemoryManager::getMemoryStart() {
    return static_cast<void*>(memoryStart);
}
...
// get bitmap representation of memory
